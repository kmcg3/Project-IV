module input_output
  ...
  contains
    subroutine open_io
      ...
      ! 
      open(unit=coords_in_io, file="/Users/katemcgarva/Desktop/NewGmin/user/lamina_phase_diagram/template/coords", form="formatted", status="old", action="read")
      read(coords_in_io, *) X
  ...
  print *, "close_io() starting"
	...
	!print *, "hereeee"
	!if (ioerr /= 0) then
 	 !print *, "Error opening file 'lowest'. IOSTAT = ", ioerr
  	! stop
       ! endif
